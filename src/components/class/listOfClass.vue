        ...
        <table class="col table table-striped table-hover table-list-search col-11" id="table_format">
          <thead class="thead-light">
            <tr class="align-text-bottom">
              ...
              <th class="text-nowrap" scope="col">Modifeé</th>
            </tr>
          </thead>
          <tbody v-for="classId in filterbyname" :key="classId._id"  id="myTable">
            <tr class="content">
              ...
              <td>
                <div @click="viewDetails(classId._id)"
                class="cursor" v-if="classId.status">
                <span class="fa fa-pencil " aria-hidden="true"></span></div>
