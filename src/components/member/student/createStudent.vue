        ...
        <form @submit.prevent="register">
          <div class="form-row align-self-center">
            ...
            <div class="col-md-4" >
              ...
              <!-- <b-form-select v-model="student.inCharge" v-for="member in members" :key="member._id" class="form-control is-valid"
              " placeholder="Responsable" aria-required="" /> -->
